...
const WhatsAppButton = ({ phoneNumber }) => {
  const message = "Oi por favor, você pode me tirar uma duvida ?";
  ...
  return (
    <motion.a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center justify-center w-16 h-16 bg-[#25D366] rounded-full shadow-lg"
